...
public abstract class ArrayFilterAbstract
{
    ...
    throws ObjectTransformerException
    {
        throw new ObjectTransformerException(
            "Filter plugin must implement the method "
            + "static boolean evaluate(JsonNode filterNode, JsonNode elementNode, ObjectTransformer transformer)");
    };
}
